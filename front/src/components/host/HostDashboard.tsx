    ...
    <div className="min-h-screen bg-slate-50 px-4 py-10">
      <div className="w-full max-w-2xl mx-auto space-y-8">
        ...
        <button
          ...
          className="w-full bg-gradient-to-b from-wine-800 to-wine-500 text-white rounded-xl py-4 font-semibold text-lg hover:from-wine-900 hover:to-wine-600 transition-colors"
        >
          + New Session
        </button>
                ...
                >
                  ...
                  <div className="flex gap-2 flex-shrink-0">
                    <button
                      ...
                      className="bg-gradient-to-b from-wine-800 to-wine-500 text-white rounded-xl px-5 py-2 font-semibold hover:from-wine-900 hover:to-wine-600 transition-colors text-sm"
                    >
                      Open
                    </button>
                    <button
